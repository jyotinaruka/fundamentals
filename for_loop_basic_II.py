...
#  returns a dictionary that has the sumTotal, 
...
def ultimate_analysis(list):
    ...
    dictionary = {'sumTotal': sumTotal, 'average': avg,
                  'minimum': min, 'maximum': max, 'length': len(list)}
    return dictionary
    


print(ultimate_analysis([45, 4, 8, -6]))

#--------------------------------------------------------------------------
# 9    Reverse List - Create a function that takes a list and return that 
